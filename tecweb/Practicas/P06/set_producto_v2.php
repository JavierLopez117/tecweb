...
if ($nombre != "" && $marca != "" && $modelo != "" && $precio != "" && $detalles != "" && $unidades != "" && $imagen != "") {
    ...
    if ($link->query($sql)) {
        ...
        echo '<br><br><strong>IMAGEN: </strong><br> <img src=http://localhost/htdocs/tecweb/Practicas/P06' . $imagen . ' width="200px" height="200px" />';
        
        echo '</p>';
    } else {
        echo '<br><strong>UN DATO O VARIOS ESTAN EN UN FORMATO INCORRECTO. POR FAVOR INGRESELOS DE NUEVO</strong>';
    }
}
 else {
