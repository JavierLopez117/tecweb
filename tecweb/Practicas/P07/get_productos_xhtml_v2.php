	...
	<script>
		function show() {
			...
			*/
			...
			var imagen = img.replace('http://localhost/tecweb/Practicas/P05/', '');
		...
		<table class="table">
			...
			<tbody>
				...
				foreach ($data as $key => $value) {
					...
					echo '<td class="row-data"><img src=http://localhost/tecweb/Practicas/P05/' . $value['imagen'] . ' width="200px" height="200px" /></td>';
