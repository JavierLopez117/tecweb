...
if (mysqli_query($link, $sql)) {
    ...
    echo '<br><br><strong>IMAGEN: </strong><br> <img src=http://localhost/tecweb/Practicas/P05/' . $imagen . ' width="200px" height="200px" />';
    echo '</p>';
} else {
    echo "ERROR no hay conexion. $sql. " . mysqli_error($link);
}
